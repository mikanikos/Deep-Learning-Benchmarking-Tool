...
data_path  = "/scratch/andpic/imageNet/cntkRecords"  #os.path.join(abs_path, "..", "..", "..", "..", "DataSets", "ImageNet")
...
def create_trainer(network, epoch_size, num_epochs, minibatch_size, num_quantization_bits, progress_printer):
    ...
    initial_learning_rate = 0.1 # equal to 0.045 in caffe
...
if __name__=='__main__':
    ...
    mean_data = os.path.join("/scratch/andpic/imageNet/cntkRecords", 'ImageNet1K_mean.xml')
