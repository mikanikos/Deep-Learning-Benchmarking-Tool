...
data_path  = "/scratch/andpic/mnist/cntkRecords"  # os.path.join(abs_path, "..", "..", "..", "DataSets", "MNIST")
...
def convnet_mnist(debug_output=False, epoch_size=60000, minibatch_size=64, max_epochs=1):
    image_height = 28
    image_width  = 28
    num_channels = 1
    ...
    lr_per_sample    = 0.01  # [0.001]*10 + [0.0005]*10 + [0.0001]
