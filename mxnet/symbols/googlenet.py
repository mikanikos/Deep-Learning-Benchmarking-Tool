...
def get_symbol(num_classes = 1000, **kwargs):
    ...
    pool1 = mx.sym.Pooling(conv1, kernel=(3, 3), stride=(2, 2), pad=(1,1), pool_type="max")
    ...
    pool3 = mx.sym.Pooling(conv3, kernel=(3, 3), stride=(2, 2), pad=(1,1), pool_type="max")
    ...
    pool4 = mx.sym.Pooling(in3b, kernel=(3, 3), stride=(2, 2), pad=(1,1), pool_type="max")
    ...
    pool5 = mx.sym.Pooling(in4e, kernel=(3, 3), stride=(2, 2), pad=(1,1), pool_type="max")
